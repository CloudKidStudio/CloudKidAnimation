...
c?c:"#000"};b.isVisible=function(){var a=this.cacheCanvas||null!=this.text&&""!==this.text;return!(!this.visible||!(0<this.alpha&&0!=this.scaleX&&0!=this.scaleY&&a))};b.DisplayObject_draw=b.draw;b.draw=function(a,b){if(this.DisplayObject_draw(a,b))return!0;this.outline?a.strokeStyle=this.color:a.fillStyle=this.color;a.font=this.font;a.textAlign=this.textAlign||"start";a.textBaseline=this.textBaseline||"alphabetic";this.stroke&&(a.lineWidth=this.stroke.width,a.strokeStyle=this.stroke.color);this._drawText(a);
...
b.DisplayObject_cloneProps=b.cloneProps;b.cloneProps=function(a){this.DisplayObject_cloneProps(a);a.textAlign=this.textAlign;a.textBaseline=this.textBaseline;a.maxWidth=this.maxWidth;a.outline=this.outline;a.lineHeight=this.lineHeight;a.lineWidth=this.lineWidth};b._getWorkingContext=function(){var a=c._workingContext;a.font=this.font;a.textAlign=this.textAlign||"start";a.textBaseline=this.textBaseline||"alphabetic";return a};b._drawText=function(a){var b=!!a;b||(a=this._getWorkingContext());for(var c=
String(this.text).split(/(?:\r\n|\r|\n)/),d=this.lineHeight||this.getMeasuredLineHeight(),e=0,f=0,g=c.length;f<g;f++){var l=a.measureText(c[f]).width;if(null==this.lineWidth||l<this.lineWidth)b&&this._drawTextLine(a,c[f],e*d);else{for(var l=c[f].split(/(\s)/),j=l[0],m=1,n=l.length;m<n;m+=2)a.measureText(j+l[m]+l[m+1]).width>this.lineWidth?(b&&this._drawTextLine(a,j,e*d),e++,j=l[m+1]):j+=l[m]+l[m+1];b&&this._drawTextLine(a,j,e*d)}e++}return e};b._drawTextLine=function(a,b,c){this.outline?a.strokeText(b,
0,c,this.maxWidth||65535):(this.stroke&&a.strokeText(b,0,c,this.maxWidth||65535),a.fillText(b,0,c,this.maxWidth||65535))};createjs.Text=c})();this.createjs=this.createjs||{};
...
c._IOS_enable=function(b){var a=b.canvas,k=b.__touch.f=function(a){c._IOS_handleEvent(b,a)};a.addEventListener("touchstart",k,!1);a.addEventListener("touchmove",k,!1);a.addEventListener("touchend",k,!1);a.addEventListener("touchcancel",k,!1)};c._IOS_disable=function(b){var a=b.canvas;a&&(b=b.__touch.f,a.removeEventListener("touchstart",b,!1),a.removeEventListener("touchmove",b,!1),a.removeEventListener("touchend",b,!1),a.removeEventListener("touchcancel",b,!1))};c._IOS_handleEvent=function(b,a){if(b){b.__touch.preventDefault&&
a.preventDefault&&a.preventDefault();for(var c=a.changedTouches,h=a.type,d=0,e=c.length;d<e;d++){var f=c[d],g=f.identifier;f.target==b.canvas&&("touchstart"==h?this._handleStart(b,g,a,f.pageX,f.pageY):"touchmove"==h?this._handleMove(b,g,a,f.pageX,f.pageY):("touchend"==h||"touchcancel"==h)&&this._handleEnd(b,g,a))}}};c._IE_enable=function(b){var a=b.canvas,k=b.__touch.f=function(a){c._IE_handleEvent(b,a)};a.addEventListener("MSPointerDown",k,!1);window.addEventListener("MSPointerMove",k,!1);window.addEventListener("MSPointerUp",
k,!1);window.addEventListener("MSPointerCancel",k,!1);b.__touch.preventDefault&&(a.style.msTouchAction="none");b.__touch.activeIDs={}};c._IE_disable=function(b){var a=b.__touch.f;window.removeEventListener("MSPointerMove",a,!1);window.removeEventListener("MSPointerUp",a,!1);window.removeEventListener("MSPointerCancel",a,!1);b.canvas&&b.canvas.removeEventListener("MSPointerDown",a,!1)};c._IE_handleEvent=function(b,a){if(b){b.__touch.preventDefault&&a.preventDefault&&a.preventDefault();var c=a.type,
h=a.pointerId,d=b.__touch.activeIDs;if("MSPointerDown"==c)a.srcElement==b.canvas&&(d[h]=!0,this._handleStart(b,h,a,a.pageX,a.pageY));else if(d[h])if("MSPointerMove"==c)this._handleMove(b,h,a,a.pageX,a.pageY);else if("MSPointerUp"==c||"MSPointerCancel"==c)delete d[h],this._handleEnd(b,h,a)}};c._handleStart=function(b,a,c,h,d){c.preventDefault();var e=b.__touch;if(e.multitouch||!e.count){var f=e.pointers;f[a]||(f[a]=!0,e.count++,b._handlePointerDown(a,c,h,d))}};c._handleMove=function(b,a,c,h,d){c.preventDefault();
b.__touch.pointers[a]&&b._handlePointerMove(a,c,h,d)};c._handleEnd=function(b,a,c){c.preventDefault();var h=b.__touch,d=h.pointers;d[a]&&(h.count--,b._handlePointerUp(a,c,!0),delete d[a])};createjs.Touch=c})();(function(){var c=this.createjs=this.createjs||{},c=c.EaselJS=c.EaselJS||{};c.version="0.6.1";c.buildDate="Fri, 20 Sep 2013 16:17:24 GMT"})();
